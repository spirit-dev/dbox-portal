...
internal class ClipboardInjector {
     ...
     * @return `undefined`
     */
    private static function injectPlainTextOnly(clipData:Object,  // NOPMD
     ...
     * @return `undefined`
     */
    private static function injectEnhancedData(clipData:Object,  // NOPMD
                                               results:Object  // NOPMD
    ):void {
     ...
     * @return Object
     */
    private static function serializeError(err:Error,
                                           format:String,
                                           clipboardType:String):Object { // NOPMD
        return {
            name: err.name,
            message: err.message,
            errorID: err.errorID,
