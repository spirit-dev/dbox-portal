...
';
    private static const processData:Function = function (data:*,  // NOPMD
                                                          stringProcessorFn:Function):* { // NOPMD
        if (typeof data === "string" && data.length > 0) {
            data = stringProcessorFn(data);
        }
        else if (typeof data === "object" && data.length > 0) {
    ...
    private static const encodeDataForJS:Function = function (data:*  // NOPMD
    ):* { // NOPMD
        return processData(data, encodeURIComponent);
    };
    private static const decodeDataFromJS:Function = function (data:*  // NOPMD
    ):* { // NOPMD
        return processData(data, decodeURIComponent);
    };
