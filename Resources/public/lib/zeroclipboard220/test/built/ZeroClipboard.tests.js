...
(function (module, test) {
    ...
    test("client methods act as expected after `destroy`", function (assert) {
        ...
        }, new RegExp("Attempted to add new listener\\(s\\) to a destroyed ZeroClipboard client instance"));
        assert.throws(function () {
            client.clip(currentEl);
        }, new RegExp("Attempted to clip element\\(s\\) to a destroyed ZeroClipboard client instance"));
        assert.throws(function () {
            client.setText("foo");
        }, new RegExp("Attempted to set pending clipboard data from a destroyed ZeroClipboard client instance"));
        assert.throws(function () {
            client.setHtml("<em>foo</em>");
        }, new RegExp("Attempted to set pending clipboard data from a destroyed ZeroClipboard client instance"));
        assert.throws(function () {
            client.setRichText("{\\rtf1\\ansi\n{\\i foo}}");
        }, new RegExp("Attempted to set pending clipboard data from a destroyed ZeroClipboard client instance"));
        assert.throws(function () {
            client.setData({"text/plain": "foo"});
        }, new RegExp("Attempted to set pending clipboard data from a destroyed ZeroClipboard client instance"));
        assert.throws(function () {
            client.clearData();
        }, new RegExp("Attempted to clear pending clipboard data from a destroyed ZeroClipboard client instance"));
        assert.throws(function () {
            tmp = client.getData();
        }, new RegExp("Attempted to get pending clipboard data from a destroyed ZeroClipboard client instance"));
    });
