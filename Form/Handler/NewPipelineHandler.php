...
//            'requestor_ticket' => $this->request->request->get('demand_new_pipeline')["ticketId"],
            'pipeline_type' => $this->request->request->get('demand_new_pipeline')["pipelineType"],
            'server_target' => $this->request->request->get('demand_new_pipeline')["serverTarget"],
            'more_info' => $this->request->request->get('demand_new_pipeline')["moreInfo"]
        ];
    }
