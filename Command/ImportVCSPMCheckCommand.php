 ...
 *  
 * File           ImportVCSPMCheckCommand.php
 ...
 */
class ImportVCSPMCheckCommand extends ContainerAwareCommand {
    ...
    protected function configure() {
        $this
            ...
            ->addOption('resume-only', false, InputOption::VALUE_NONE, 'Display only the resume.')
            ->setHelp(<<<EOT
